...
* HTML5 header elements (_scroll-affix.js_)
...
* refactored scroll changes (_scroll-affix.js_)
* scroll changes → _scroll-affix.js_
...
### Fixed
* scroll changes `$(document).on('ready', function() {` → `$(document).ready(function() {` (_scroll-affix.js_)
